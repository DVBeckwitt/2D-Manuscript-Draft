...
def _accumulate_state_block_kernel(
    ...
    is_m0 = int(rod_hk_population[rod_index, 0]) == 0 and int(rod_hk_population[rod_index, 1]) == 0
    ...
    for local_state in range(local_state_count):
        ...
        for x_branch in range(2):
            ...
            if is_m0:
                ...
                radial_sign_phase = 0.0 if x_branch == 1 else math.pi
            ...
            for w_branch in range(2):
                ...
                if x_caustic or w_caustic:
                    if is_m0:
                        ...
                        reconstructed_local_x = x_value * math.cos(direction_azimuth)
                        reconstructed_local_y = x_value * math.sin(direction_azimuth)
