...
ROD_POLAR_LINE_MOSAIC_MODEL_ID = "painted_ewald.m0_folded_nonzero_signed_polar_line.v1"
ROD_POLAR_LINE_COORDINATE_SEMANTICS_ID = (
    "painted_ewald.m0_folded_alpha_nonzero_signed_delta_rod_local_beta.v1"
)
ROD_POLAR_LINE_PROBABILITY_MEASURE_ID = (
    "m0_dalpha_nonzero_ddelta_dbeta_probability.v2"
)
