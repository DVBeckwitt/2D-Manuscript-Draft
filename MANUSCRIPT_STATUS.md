...
- Does it distinguish the radial $m=0$, $L=3$ wavelength result from the transverse mosaic observable and tie the assignment to the full-spectrum versus mean-wavelength control?
