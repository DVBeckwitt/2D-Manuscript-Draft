# PbI2 phi-profile Gaussian/Lorentzian fits
...
Detailed CSV: `figure7c_pbi2_line_profile_fits_phi_lorentzian_gaussian_fits.csv`
Summary CSV: `figure7c_pbi2_line_profile_fits_phi_lorentzian_gaussian_fits_summary.csv`
Quality CSV: `figure7c_pbi2_line_profile_fits_profile_fit_quality.csv`
Accepted profile rows: 7
Rejected profile rows: 0
Reported phi rows: 6
Successful reported phi rows: 6
