...
\begin{tikzpicture}[tdplot_main_coords, scale=1.5]
    ...
    % Draw back face
    \draw[very thick]
      (detBBL) -- (detBBR) -- (detBTR) -- (detBTL) -- cycle;
    ...
    \draw[->, black, line width=0.2mm] (detCenter) -- ($ (detCenter) + 0.9*(detU) $)
      node[anchor=west, scale=0.6] {$x'$};
    \draw[->, black, line width=0.2mm] (detCenter) -- ($ (detCenter) + 0.9*(detV) $)
      node[anchor=south, scale=0.6] {$z'$};
    \coordinate (detNormalBase) at ($ (detCenter) + 0.55*(detU) - 0.35*(detV) $);
    \coordinate (detNormalTip) at ($ (detNormalBase) - 2.3*(detTvec) $);
    \draw[->, black, line width=0.25mm] (detNormalBase) -- (detNormalTip)
      node[anchor=south east, scale=0.58, xshift=-2pt, yshift=1pt] {$\hat{n}_{\mathrm{det}}$};
    ...
    \tdplotdrawarc[dashed, green,tdplot_rotated_coords, line width=0.1mm]
      {(0,1.4,0)}{0.5}{15}{90}
      {anchor=south east}{\scriptsize $2\theta$}
