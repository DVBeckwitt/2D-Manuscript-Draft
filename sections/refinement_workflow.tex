...
\begin{table}[!ht]
  \centering
  \caption{Staged refinement workflow. Steps 1--5 are used for the ordered Bi$_2$Se$_3$ and Bi$_2$Te$_3$ test cases. Step 6 is the added PbI$_2$ extension for stacking-fault diffuse scattering. All sample images are dark-subtracted before the listed observables are formed, and the final measured/calculated comparison applies the same detector-space projection to data and calculation.}
