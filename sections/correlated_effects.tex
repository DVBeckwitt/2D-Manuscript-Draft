...
The specular-family profiles in this near-critical region are 
calculated with an optical-to-structural handoff. The low-\(Q_z\) branch is calculated with a Parratt
...
is matched to a normalized finite-stack structure term.
...
\begin{figure}[H]
  ...
  finite-stack structure term scaled to the optical
