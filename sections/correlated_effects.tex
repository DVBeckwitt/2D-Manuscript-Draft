...
The anomylous intensity along $2\theta$ for the m=0, L=3 feature in Fig.~\ref{fig:hk0_low_l_star} can be explained by the bandwidth forming an ewald shell on a much smaller Bragg sphere. In this
