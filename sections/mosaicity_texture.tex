...
\begin{figure}[H]
  ...
  \caption{Schematic of crystallite layer-normal misorientation (mosaicity) about the surface normal ($\hat{n}$ of the substrate). A distribution of crystallite orientations may form in a thin film.}
  \label{fig:mosaic}
\end{figure}
