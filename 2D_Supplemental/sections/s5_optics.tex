...
\end{equation}
The $Q_{\mathrm{loc}}^{-2}$ factor gives the high-$Q_{\mathrm{loc}}$ structural envelope, while the
...
\begin{equation}
  ...
  \left(
  \ln R_{\mathrm P}(Q_{\mathrm{loc},i})-
  \ln R_{\mathrm{kin}}^{(0)}(Q_{\mathrm{loc},i})
  \right)
  \right],
  \label{eq:si_crossover_scale}
\end{equation}
with the default overlap window $5<Q_{\mathrm{loc}}/Q_c<10$. The scaled kinematic branch is
\begin{equation}
