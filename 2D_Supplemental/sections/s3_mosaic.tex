...
\end{equation}
Thus $\int_0^\pi p_\alpha\,d\alpha=1$ and $\int_0^\pi\int_0^{2\pi}p_m\,d\beta\,d\alpha=1$. The product $p_m\,d\alpha\,d\beta$ is the probability of a crystallite orientation within that angular interval. When the same normal directions are expressed as a density per solid angle, $d\Omega=\sin\alpha\,d\alpha\,d\beta$, the corresponding density is
\begin{equation}
